...
部分预置用户属性支持在 [360画像](/op/v/2.0/product-manual/user-insights/user-profiles#yong-hu-sou-suo-ye) 中搜索用户
...
首次识别日期( $first\_day )为系统首次识别用户，生成gio\_id的具体日期，用户生成规则详见 [用户模型](/op/v/2.0/getting-started/basic-concept/user-identifications)。
