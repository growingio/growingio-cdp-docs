...
- 仅展示该空间中被授权查看的用户属性 。
- 可勾选展示有值的用户身份、用户属性、用户标签、融合历史和用户资产。
...
在用户资产页面，可以看到在数据中心定义的用户资产模型数据。

![picture 3](/img/7bb93f2121888b39a8355bd9f11a9db1380a3b2f7b4245b724a24a9d17e71334_pic_1685428876897_2023-05-30.png)  
