...
创建相应类型的数据源，使用说明请参考[数据源管理](/op/v/2.0/product-manual/customer-data-platform/datasource/datasource-manage)​

需要有该模块的权限，如无权限请找**管理员**开通

数据导入用户行为数据：预置事件（如$visit、$page等）、预置事件属性（$domain、$city、$ip等等）范围格式

用户属性：[预置用户属性范围及格式详见用户管理](/op/v/2.0/product-manual/customer-data-platform/user/user-properties#yu-zhi-yong-hu-shu-xing)​
...
### 选择数据导入类型，[用户行为数据](/op/v/2.0/product-manual/customer-data-platform/datasource/data-import#yong-hu-hang-wei-shu-ju)或[用户属性数据](/op/v/2.0/product-manual/customer-data-platform/datasource/data-import#yong-hu-shu-xing-shu-ju)​[](#xuan-ze-shu-ju-dao-ru-lei-xing-yong-hu-hang-wei-shu-ju-huo-yong-hu-shu-xing-shu-ju)
...
选择上传方式：[CSV](/op/v/2.0/product-manual/customer-data-platform/datasource/data-import#yong-hu-hang-wei-shu-ju-csv-ge-shi)、[JSON](/op/v/2.0/product-manual/customer-data-platform/datasource/data-import#yong-hu-hang-wei-shu-ju)、FTP
...
选择上传方式：[CSV](/op/v/2.0/product-manual/customer-data-platform/datasource/data-import#yong-hu-shu-xing-csv-ge-shi)、[JSON](/op/v/2.0/product-manual/customer-data-platform/datasource/data-import#yong-hu-shu-xing-json-ge-shi)、FTP


### 确定创建任务[](#que-ding-chuang-jian-ren-wu)

### 上传数据，将按照固定[数据格式](/op/v/2.0/product-manual/customer-data-platform/datasource/data-import#shu-ju-dao-ru-ge-shi)导入CDP[](#shang-chuan-shu-ju-jiang-an-zhao-gu-ding-shu-ju-ge-shi-dao-ru-cdp)
...
选择FTP：提供任务目录地址，将JSON文件放入FTP目录中，格式参考[数据格式JSON](/op/v/2.0/product-manual/customer-data-platform/datasource/data-import#yong-hu-hang-wei-shu-ju-json-ge-shi)。将数据放入指定FTP目录，点击“操作”，查看文件上传，勾选注意事项，进行下一步
...
​[详见用户管理模块](/op/v/2.0/product-manual/customer-data-platform/user/user-properties#yu-zhi-yong-hu-shu-xing)​
