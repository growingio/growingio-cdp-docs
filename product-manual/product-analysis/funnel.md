...
![](https://gblobscdn.gitbook.com/assets%2F-M2qbZInaXgdm8kkNosp%2Fsync%2Fc7ca813cedca48da9c7e5bf95aee8db8bb4bea23.png?alt=media)

二、单击右侧列表上方"**新建漏斗分析"**，进入**创建漏斗分析**页面。

三、依据以下步骤配置漏斗。

![](https://gblobscdn.gitbook.com/assets%2F-M2qbZInaXgdm8kkNosp%2Fsync%2F729be50337589fc51c609377a8e3e248313c1883.png?alt=media)

| 项   | 说明  |
| --- | --- |
| 1-事件选择 | 至少选择2个步骤，单击确定后展示漏斗视图。 |
| 2-事件过滤 | 单击已选步骤右侧的 ![](https://docs.growingio.com/.gitbook/assets/-Lo08UtW7H58ehFKeZ4g-Ltde2dMkj6vvIsEg0mZ-LtdfDNBSgq16S3kCwqjE6BC8FE69697.png) ，配置当前步骤单独的过滤条件。 |
...
![](https://gblobscdn.gitbook.com/assets%2F-M2qbZInaXgdm8kkNosp%2Fsync%2Fd2f8574a06a4b7b32181926837fae0813cf6bf31.png?alt=media)
