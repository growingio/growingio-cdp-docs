...
* 新功能
  * 产品分析： 新增看板模块
    * 独立数据报表查看模块，帮助非分析师成员，专注于数据的消费。 
    * 看板支持订阅 / 取消订阅：可将你当前关注的看板 订阅致侧栏，帮助你快速查找。 
    * 看板支持拖拉排序： 可在看版侧边栏将看板进行“拖拽”改变看板顺序。 
  * 产品分析： 看板共享设置
    * 通过看板共享设置，可以实现 看板只可与 特定成员进行共享 。 
    * 可选择 共享的方式为 阅读者- 仅可查看看板 ，编辑者- 可查看且可编辑 。  
    * 支持看板批量设置 共享模式。
* 優化：
  * 优化看板管理方式：列表管理更有助于管理 大量看板。
...
* 新功能:
  ...
  * SDK: 新增[**网站和微信小程序全局指标**](introduction/term.md)无埋点数据采集
