...
* 新增
    ...
    * ​[用户删除管理](/op/v/2.0/product-manual/customer-data-platform/datasource/yong-hu-shan-chu-guan-li)：遵循GDPR欧盟规范，支持指定用户删除底层数据
...
* 新增
    ...
    * 虚拟事件：客户数据平台新增虚拟事件功能，支持合并、拆解预置事件和埋点，满足多项目数据隔离的使用场景。
        ...
        * 支持[虚拟事件](/op/v/2.0/product-manual/customer-data-platform/event-management/virtualevents)​
...
* 优化
    ...
    * 客户数据平台[用户标签](/op/v/2.0/product-manual/customer-data-platform/user/user-tags)模块界面升级：
...
* 新增
    ...
    * 用戶
        ...
        * 用户信息融合到预置[用户属性](/op/v/2.0/product-manual/customer-data-platform/user/user-properties)，支持在分析等场景中使用
            
        * 新增[用户ID](/op/v/2.0/product-manual/customer-data-platform/user/user-identifications)模块，支持查看GrowingIO用户识别配置方案
...
* 新功能:
    ...
    * 数据平台：[用户属性支持分类管理](/op/v/2.0/product-manual/customer-data-platform/user/user-properties)​
...
* 新功能:
    ...
    * 全局指标：新增支持[总页面停留时长、平均页面停留时长、跳出次数](/op/v/2.0/product-manual/customer-data-platform/complex/term#yu-ding-yi-zhi-biao)​
...
* 新功能:
    ...
    * 全局指标: [新增支持退出次数](/op/v/2.0/product-manual/customer-data-platform/complex/term)​
...
* 新功能:
    ...
    * 全局指标：支持iOS 和 Android无埋点[全局指标](/op/v/2.0/product-manual/customer-data-platform/complex/term#quan-ju-zhi-biao)采集
...
* 新功能:
    ...
    * 数据平台: 新增[**utm映射功能**](/op/v/2.0/product-manual/customer-data-platform/data-center/utm-map)**​**
    ...
    * SDK: 新增[**网站和微信小程序全局指标**](/op/v/2.0/product-manual/customer-data-platform/complex/term)无埋点数据采集
