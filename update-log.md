...
* 优化:
  ...
  * 数据导入:
    ...
    * 属性数据支持新用户属性导入
* 修复:
  * 修复历史数据导入后event表中attributes字段没有存储非string类型属性问题
...
## v2020.11.7.7：2021年1月6日发布

* 优化:
  * 维度选择器属性值搜索支持用户属性

## v2020.11.7.1：2020年12月30日发布

* 优化:
  * 优化hbase，提升标签、分群下载计算任务速度
  * 提升hive数据导出任务优先级
* 修复:
  * 增加offline oom退出参数，解决部分场景僵死问题

## v2020.11.7：2020年12月29日发布
...
>>>>>>> 14.3.0-beta
  ...
  * 企业功能：[事件管理、事件属性、用户属性、物品管理、标签支持只读权限](product-manual/qi-ye-guan-li-hou-tai/enterprise--role.md)
  * 企业功能：支持采集系统用户行为日志
* 优化: 
  * 产品分析：看版拖拽体验优化
...
* 新功能:
  ...
  * 数据平台: 新增[**utm映射功能**](product-manual/customer-data-platform/data-center/utm-map.md)\*\*\*\*
    * 支持创建utm映射规则
    * 支持批量创建
  * 数据平台: 新增前端界面**下载功能**
