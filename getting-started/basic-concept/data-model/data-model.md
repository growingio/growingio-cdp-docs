...
* 事件标识符、发生时间、用户ID等基础信息，字段无前缀
* 城市、浏览器、设备类型等预定义属性，字段统一使用 $ 符号前缀
* 埋点上报的自定义属性，字段统一使用 var_ 作为前缀
...
> * 自定义事件：通过eventkey、event_time、anonymous_user、user、attributes等加密生成
