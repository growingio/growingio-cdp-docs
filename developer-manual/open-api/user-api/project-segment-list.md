...
| name | String | 名称 |
| key | String | 标识符 |
| createdBy | String | 分群类型cDIRECT：规则创建<br></br>FROM_FUNNEL：漏斗创建<br></br>FROM_RETENTION：留存创建<br></br>FROM_FREQUENCY：分布分析创建<br></br>FROM_FILES：文件上传 |
...
场景：在项目 WlGk4Daj 查询全部已定义的群体画像信息
